...
public class Listener implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		// TODO Auto-generated method stubSystem.out.println("Test started: "+result.getName());
		BaseClass.test.fail("Test failed"+result.getName());
		try {
			BaseClass.test.addScreencastFromPath(CommonMethods.takeScreenshot("Failed/"+result.getName()));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
